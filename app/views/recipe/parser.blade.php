...
@section('content')
    <div class="form-group">
        <div class="row">
            ...
            <div class="col-md-2">
                <a href="#" id="example" class="btn btn-danger btn-xs padding-left">Example Recipe</a>
            </div>
        </div>
...
1 lemon twist'
            ...
            $('textarea[name=recipe]').on('paste', function() {
               var self = this;
               NProgress.start();
               setTimeout(function() {
                   // Remove commas, and common , {style} data
                   var paste = $(self).val().replace(/(,\s*\w*$)|,/gim, '').split('\n'),
                       ingredients = [];
